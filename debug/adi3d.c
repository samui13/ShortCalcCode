...
void CalcStep1(double ***u,int first,int end); //z,y,x
void CalcStep2(double ***u,int first,int end); //z,x,y
void CalcStep3(double ***u,double ***un,int first,int end); //x,y,z
void End();
...
#pragma omp section
    {
      CalcStep3(u,un,0,Nx/2);
    }
#pragma omp section
    {
      CalcStep3(u,un,Nx/2+1,Nx);
    }
  }
#endif  
...
void CalcStep1(double ***u,int first,int end){
  int i,i1,i2,i3,i4;
  int j,j1,j2,j3,j4;
  int k,k1,k2,k3,k4;
...
void CalcStep2(double ***u,int first,int end){
  int i,i1,i2,i3,i4;
  int j,j1,j2,j3,j4;
  int k,k1,k2,k3,k4;
...
void CalcStep3(double ***u,double ***un,int first,int end){
  int i,i1,i2,i3,i4;
  int j,j1,j2,j3,j4;
  int k,k1,k2,k3,k4;
